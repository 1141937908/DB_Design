 ...
 */
public class Subscription extends AbstractTableModel{
    Vector rowData,columnNames;
    Daodbc dbc;

    public void querySubscription(String sql,String[] paras){
    ...
    public boolean updateSubscription(String sql,String paras[]) throws Exception {
        dbc=new Daodbc();
